...
\textbf{Proponentes:} & Antonio Contesti Coll (graduado, EPS-UIB) · Marc Link Cladera (coautor del proyecto base UIB) \\
...
\textbf{Origen:} & Trabajo de Fin de Grado EPS-UIB (Grado en Ingeniería Informática) y desarrollo posterior como prototipo hospitalario funcional. \\
\end{tabularx}
...
\textbf{Para el paciente:} reducción del riesgo de falsos negativos en CXR (actualmente 20--50\,\%), aceleración del triaje en sospecha de cáncer de pulmón y \textbf{segunda lectura algorítmica} complementaria al criterio del radiólogo. \textbf{Para el sistema sanitario:} alivio de la presión asistencial sobre el Servicio de Radiología del Hospital Universitari Son Llàtzer, con latencia $<$3\,s compatible con el flujo radiológico estándar y preparado para integración PACS por DICOM C-STORE. \textbf{Para la comunidad de investigación:} la publicación abierta del protocolo de auditoría de \emph{data leakage}, del análisis crítico del código del estado del arte y del hallazgo del \emph{score threshold} cubren huecos identificados en la literatura sobre \emph{reproducibility} en IA médica. \textbf{Para la sociedad:} código y documentación publicados en GitHub bajo licencia abierta.

\section*{7. Cooperación UIB · IB-Salut · línea internacional}

\begin{itemize}[leftmargin=1.2em, itemsep=1pt, topsep=1pt]
\item \textbf{UIB} (Escola Politècnica Superior) --- Dr.~Miquel Miró Nicolau, \emph{profesor ayudante doctor} del Departamento de Ciencias Matemáticas e Informática (línea de \emph{eXplainable AI}), aporta la dirección académica y metodológica. Marc Link Cladera (coautor del proyecto base UIB) contribuyó con los modelos iniciales. Antonio Contesti Coll lidera el desarrollo actual del prototipo hospitalario completo y la auditoría crítica del estado del arte.
\item \textbf{IB-Salut, Hospital Universitari Son Llàtzer} --- Dra.~Ana Estremera Bauzá, jefa del Servicio de Radiología, aporta el conocimiento clínico, los requisitos funcionales del prototipo (interfaz, casos de uso, integración con PACS) y la perspectiva del impacto real en consulta; codiseño del módulo de validación que cierra el ciclo de mejora.
\item \textbf{Línea internacional} --- comparación directa con el ganador del NODE21 Challenge (Behrendt \emph{et al.}, Hamburg University of Technology), referente mundial en detección de nódulos en CXR.
\end{itemize}
...
\begin{tabular}{@{}ll@{}}
Memoria académica del TFG (PDF) & \emph{adjunta a la candidatura} \\
...
Documentación técnica completa (\emph{wiki}) & \emph{adjunta a la candidatura} \\
Demostración en vivo del prototipo & \emph{operativo en LAN Hospital Son Llàtzer} \\
\end{tabular}}
