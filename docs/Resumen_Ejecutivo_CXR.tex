...
\item \textbf{IB-Salut, Hospital Universitari Son Llàtzer} --- Dra.~Ana Estremera Rodrigo, jefa del Servicio de Radiología, aporta el conocimiento clínico, los requisitos funcionales del prototipo (interfaz, casos de uso, integración con PACS) y la perspectiva del impacto real en consulta; codiseño del módulo de validación que cierra el ciclo de mejora.
